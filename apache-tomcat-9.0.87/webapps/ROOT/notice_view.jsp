...
<%@ page import="ogrg.zerock.webtest1.dao.NoticeDAO" %>
<%@ page import="ogrg.zerock.webtest1.dto.NoticeDTO" %>
<%@ page import="java.util.List" %>

<%
	// URL에서 전달된 공지사항 번호를 받아옵니다.
	String noticeNo = request.getParameter("no");
	// NoticeDAO 객체를 생성합니다.
	NoticeDAO noticeDAO = new NoticeDAO();
	// 공지사항 번호를 이용하여 해당 공지사항의 정보를 가져옵니다.
	NoticeDTO noticeDTO = noticeDAO.getNoticeByNo(Integer.parseInt(noticeNo));
%>
<!DOCTYPE html>
<html lang="ko">
<head>
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<ul class="bbsview_list">
				<li class="bbs_title"><%= noticeDTO.getTitle() %></li>
				<li class="bbs_hit">작성일 : <span><%= noticeDTO.getCreate_date() %></span></li>
				<li class="bbs_date">조회수 : <span><%= noticeDTO.getCount() %></span></li>
			...
			<p class="btn_line txt_right">
				...
				<a href="/noticeDelete?no=<%= noticeDTO.getNo() %>" class="btn_bbs">삭제</a>
			</p>
