					...
					<ul class="app_list">
						<li class="clear">
							...
							<div class="app_content email_area">
								<input type="text" class="w160" id="email_lbl" title="이메일 주소" name="email1"/>
						...
						<li class="clear">
							<label for="name_lbl" class="tit_lbl pilsoo_item" name="name">작성자명</label>
							<div class="app_content"><input type="text" class="w100p" id="name_lbl" name="name" placeholder="이름을 입력해주세요"/></div>
						</li>
						<li class="clear">
							<label for="pwd_lbl" class="tit_lbl pilsoo_item" name="memberPw">비밀번호</label>
						...
						<li class="clear">
							<label for="phone_lbl" class="tit_lbl pilsoo_item" name="phone">연락처</label>
						...
						<li class="clear">
							...
							<div class="app_content"><textarea id="content_lbl" class="w100p" placeholder="간단한 상담 요청 사항을 남겨주시면 보다 상세한 상담이 가능합니다. 전화 상담 희망시 기재 부탁드립니다." name="content"></textarea></div>
						</li>
					</ul>
					<p class="btn_line"><a href="javascript:;" class="btn_baseColor" onclick="insertMember();">등록</a></p>
